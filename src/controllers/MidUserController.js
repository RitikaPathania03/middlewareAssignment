...
const createMidUser= async function(req,res,next){
    let MidUser=req.body
    let MidUserCreated= await MidUserModel.create(user)
    res.send({data:MidUserCreated})
}
module.exports.createMidUser=createMidUser
